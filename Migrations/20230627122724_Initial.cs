    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Iban = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Addresses_Id_TenantId",
                table: "Addresses",
                columns: new[] { "Id", "TenantId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_BankAccounts_Id_TenantId",
                table: "BankAccounts",
                columns: new[] { "Id", "TenantId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_InvoiceItems_Id_TenantId",
                table: "InvoiceItems",
                columns: new[] { "Id", "TenantId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Invoices_Id_TenantId",
                table: "Invoices",
                columns: new[] { "Id", "TenantId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_OrderItems_Id_TenantId",
                table: "OrderItems",
                columns: new[] { "Id", "TenantId" },
                unique: true);
